...
if(isset($_POST["EN"]) && isset($_POST["EDIS"]) && isset($_POST["EPN"]) && isset($_POST["EPO"]) && isset($_POST["ECNo"])&& isset($_POST["RLN"])&& isset($_POST["PassNo"]) ){
...
if( isset($_POST["MOBNo"])){$_SESSION["MOBNo"]=$_POST["MOBNo"];}
		 ...
		 <tr>
		  ...
		  <tr>
            ...
            <td>
              ...
              <?php }else{ ?>
                <option value="SHONALI BANK" >DHAKA</option>
              <?php } ?>
